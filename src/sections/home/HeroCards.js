...
const HeroCards = () => {
	...
	useEffect(() => {
		...
		return () => {
			isClient && window.removeEventListener('scroll', scrollFunction);
		};
	}, []);
		...
		<section className='hero'>
			<div className='hero-box-container'>
				<Link to='/about' className='hero-box'>
					<span
						ref={heroBlue}
						className='hero-box__circle hero-box__circle--blue'></span>
				...
				<Link to='/about/#aboutus' className='hero-box'>
					<span
						ref={heroGreen}
						className='hero-box__circle hero-box__circle--green'></span>
				...
				<Link to='/learn' className='hero-box'>
					<span
						ref={heroOrange}
						className='hero-box__circle hero-box__circle--orange'></span>
